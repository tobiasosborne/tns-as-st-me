...
*Justification.*  The commuting primitive-circle generators of §2 each obey
D26(INT), so their joint on-site spectrum lies in one affine coset of
`ℤ^r`, and same-window TPM cancels the common offset; D26 and claim
M-INDEX-fin give the one-circle affine-coset arithmetic.  (Citation
repaired per critic blitz-scope-g-r1 minor: S-IDX-G-label concerns
represented charge/current sector shifts, not the on-site joint charge
spectrum used here.)

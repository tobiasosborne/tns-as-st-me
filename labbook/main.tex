...
\include{sections/01_dictionary}
\include{sections/02_mps_setting}
\include{sections/03_symmetry_noether}
\include{sections/04_corner_a}
\include{sections/05_kink_model}
\include{sections/06_memory_quantization}
\include{sections/07_memory_index}
\include{sections/08_local_relaxation}
\include{sections/09_two_magnon}
\include{sections/10_wave_operators}
\include{sections/11_soft_index}
\include{sections/12_universality}
\include{sections/13_spt}
\include{sections/14_two_plus_one}
\include{sections/15_negative_results}
\include{sections/16_numerics}
\include{sections/17_triangle_status}
\include{sections/18_continuum_reduction}

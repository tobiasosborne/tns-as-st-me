...
\subsubsection*{First execution of the decisive computation (unadjudicated)}

The computation \eqref{eq:op-T1}--\eqref{eq:op-T3} has now been executed by
two independent lanes whose outputs are awaiting adversarial adjudication;
nothing in this paragraph enters the claim ledger. Before the lanes ran, the
...
\eqref{eq:op-T3} is named but not performed. No claim status changed in this
